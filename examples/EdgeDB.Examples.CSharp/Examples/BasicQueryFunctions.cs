...
public class BasicQueryFunctions : IExample
{
    ...
    public async Task ExecuteAsync(GelClientPool clientPool)
    {
        ...
        var str = await clientPool.QueryAsync<string>("select \"Hello, DotNet!\"");
        ...
        var singleStr = await clientPool.QuerySingleAsync<string>("select \"Hello, DotNet!\"");
        ...
        var singleRequiredStr = await clientPool.QueryRequiredSingleAsync<string>("select \"Hello, DotNet!\"");
        ...
        await clientPool.ExecuteAsync("select \"Hello, DotNet!\"");
