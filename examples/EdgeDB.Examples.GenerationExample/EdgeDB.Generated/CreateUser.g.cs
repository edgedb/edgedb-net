...
// Generated on 2023-07-19T16:41:46.1204340Z
#nullable enable
using EdgeDB;
...
""";
    ...
    public static Task<CreateUserDefaultPerson> ExecuteAsync(IEdgeDBQueryable client, String name, String email, CancellationToken token = default)
        => client.QueryRequiredSingleAsync<CreateUserDefaultPerson>(
    ...
    /// <param name="name">The name parameter in the query.</param>
    /// <param name="email">The email parameter in the query.</param>
    public static Task<CreateUserDefaultPerson> CreateUserAsync(this IEdgeDBQueryable client, String name, String email, CancellationToken token = default)
