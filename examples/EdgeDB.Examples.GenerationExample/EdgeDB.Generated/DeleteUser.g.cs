...
// Generated on 2023-07-19T16:41:46.1382904Z
#nullable enable
using EdgeDB;
...
""";
    ...
    public static Task<DeleteUserDefaultPerson?> ExecuteAsync(IEdgeDBQueryable client, String email, CancellationToken token = default)
        => client.QuerySingleAsync<DeleteUserDefaultPerson?>(
    ...
    /// <param name="client">The client to execute the query on.</param>
    /// <param name="email">The email parameter in the query.</param>
    public static Task<DeleteUserDefaultPerson?> DeleteUserAsync(this IEdgeDBQueryable client, String email, CancellationToken token = default)
