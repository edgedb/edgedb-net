...
// Generated on 2022-12-06T20:36:05.1471596Z
#nullable enable
using EdgeDB;
...
SET {
    ...
    public static Task<UserModel?> ExecuteAsync(IEdgeDBQueryable client, string? name, string? email, Guid id, CancellationToken token = default)
        => client.QuerySingleAsync<UserModel>(Query, new Dictionary<string, object?>() { { "name", name }, { "email", email }, { "id", id } }, capabilities: (Capabilities)1ul, token: token);
    ...
    /// <param name="token">A cancellation token used to cancel the asyncronous query.</param>
    /// <returns>A Task representing the asynchronous query operation. The result of the task is the result of the query.</returns>
    public static Task<UserModel?> UpdateUserAsync(this IEdgeDBQueryable client, string? name, string? email, Guid id, CancellationToken token = default)
