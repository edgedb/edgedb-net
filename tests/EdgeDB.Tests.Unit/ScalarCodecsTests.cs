...
public class ScalarCodecsTests
{
    ...
    {
        var codec = CodecBuilder.GetScalarCodec<DateTime>();

        var data = new byte[] {0x00, 0x02, 0x2b, 0x35, 0x9b, 0xc4, 0x10, 0x00};
        var expected = new DateTime(DateTimeOffset.Parse("2019-05-06T12:00+00:00"));
    ...
    public void TestFloat32()
    {
        ...
        var data = new byte[] {0xc1, 0x7a, 0x00, 0x00};
    ...
    public void TestFloat64()
    {
        ...
        var data = new byte[] {0xc0, 0x2f, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00};
    ...
    public void TestInt32()
    {
        ...
        var data = new byte[] {0x00, 0x0a, 0x01, 0x31};
    ...
    public void TestInt64()
    {
        ...
        var data = new byte[] {0x01, 0xb6, 0x9b, 0x4b, 0xe0, 0x52, 0xfa, 0xb1};

        var expected = 123456789987654321;
    ...
    {
        var codec = CodecBuilder.GetScalarCodec<Json>();
        ...
        var expected = new Json("{ \"Hello\": \"World!\"}");
    ...
    {
        var codec = CodecBuilder.GetScalarCodec<Memory>();

        var data = new byte[] {0x00, 0x00, 0x00, 0x00, 0x07, 0xb0, 0x00, 0x00};

        var expected = new Memory(128974848);
    ...
    public void TestText()
    {
        ...
        var data = new byte[] {72, 101, 108, 108, 111, 32, 87, 111, 114, 108, 100, 33};
