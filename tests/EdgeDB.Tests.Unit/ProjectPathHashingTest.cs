...
public class ProjectPathHashingTest
{
    ...
    private void TestProjectHashing(OSPlatform platform, string homeDir, string projectDir, string? xdgconf,
    ...
    private class MockSystemProvider : ISystemProvider
    {
        ...
        public MockSystemProvider(OSPlatform platform, string home, Dictionary<string, string> env,
            params string[] dirs)
        {
            _dirs = dirs;
            _home = home;
