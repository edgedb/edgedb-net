...
internal class MemberExpressionTranslator : ExpressionTranslator<MemberExpression>
{
    ...
    private void TranslateParameterMember(QueryWriter writer, ParameterExpression parameter, MemberExpression[] path,
        ExpressionContext context)
    {
    ...
    private void TranslateContextMember(QueryWriter writer, Expression contextExpression, MemberExpression[] path,
        ExpressionContext context)
    {
