...
internal class EnumerableMethodTranslator : MethodTranslator
{
    ...
    public void Distinct(QueryWriter writer, TranslatedParameter source) => writer.Append("distinct ", source);
    ...
    public void Select(QueryWriter writer, MethodCallExpression method, TranslatedParameter source,
        TranslatedParameter expressive, ExpressionContext context)
    {
                ...
                x.ParameterAliases.Add(lambda.Parameters[0], Token.Of(
                        writer => writer
                            .Term(
                                ...
                                enumerationName,
                                Defer.This(
                                    () => "Enumeration global reference element for Enumerable.Select translator"),
    ...
    public void FirstOrDefault(QueryWriter writer, TranslatedParameter source, TranslatedParameter filterOrDefault,
        TranslatedParameter? defaultValue)
    {
