...
public abstract class QueryContext : IQueryContext
{
    ...
    ///     To return a specific type use
    ///     <see cref="BackLink{TType}(System.Linq.Expressions.Expression{System.Func{TType,object}})" />.
    /// </returns>
...
public abstract class QueryContextSelfVars<TSelf, TVars> : QueryContext, IQueryContextSelf<TSelf>,
    IQueryContextVars<TVars>
{
    public abstract TSelf Self { get; }
...
public abstract class QueryContextSelfUsing<TSelf, TUsing> : QueryContext, IQueryContextUsing<TUsing>,
    IQueryContextSelf<TSelf>
{
    public abstract TSelf Self { get; }
    public abstract TUsing Using { get; }
}

public abstract class QueryContextUsingVars<TUsing, TVars> : QueryContext, IQueryContextUsing<TUsing>,
    IQueryContextVars<TVars>
{
    public abstract TUsing Using { get; }
    public abstract TVars Variables { get; }
...
public abstract class QueryContextSelfUsingVars<TSelf, TUsing, TVars> : QueryContext, IQueryContextUsing<TUsing>,
    IQueryContextVars<TVars>, IQueryContextSelf<TSelf>
{
    public abstract TSelf Self { get; }
    public abstract TUsing Using { get; }
    public abstract TVars Variables { get; }
