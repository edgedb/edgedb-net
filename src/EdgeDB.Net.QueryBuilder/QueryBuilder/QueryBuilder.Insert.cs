...
public static partial class QueryBuilder
{
    ...
    public static IInsertQuery<TType, QueryContextSelf<TType>> Insert<TType>(
        Expression<Func<QueryContextSelf<TType>, TType>> value, bool returnInsertedValue)
    ...
    public static IInsertQuery<TType, QueryContextSelf<TType>> Insert<TType>(
        Expression<Func<QueryContextSelf<TType>, TType>> value)
...
public partial class QueryBuilder<TType, TContext>
{
    ...
    public IInsertQuery<TType, TContext> Insert(Type type, IDictionary<string, object?> values,
        bool returnInsertedValue = true)
    {
