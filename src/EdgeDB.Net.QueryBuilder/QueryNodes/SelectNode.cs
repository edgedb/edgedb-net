...
internal class SelectNode : QueryNode<SelectContext>
{
    ...
    internal void Offset(long offset) => OffsetProxy ??= writer => writer.Append(" offset ", offset);
    ...
    internal void Limit(long limit) => LimitProxy ??= writer => writer.Append(" limit ", limit);
