...
internal abstract class QueryNode
{
    ...
    public QueryNode(NodeBuilder builder)
    {
        ...
        NodeTranslationContext = new NodeTranslationContext(this);
    }
    ...
    protected void SetVariable(string name, object? value) => Builder.QueryVariables[name] = value;
    ...
    protected void TranslateExpression(LambdaExpression expression, QueryWriter writer,
        Action<ExpressionContext>? context = null)
    {
    ...
    protected WriterProxy ProxyExpression(LambdaExpression expression, Action<ExpressionContext>? context = null) =>
        writer => TranslateExpression(expression, writer, context);
