    ...
    where TContext : IQueryContext
{
    ...
    IMultiCardinalityExecutable<TNew> For<U, TNew>(IEnumerable<U> collection,
    ...
    /// <typeparam name="TNew">The type returned from the iterator query.</typeparam>
    /// <returns>The current query.</returns>
    IMultiCardinalityExecutable<TNew> For<U, TNew>(Expression<Func<TContext, IEnumerable<U>>> collection,
        Expression<Func<JsonCollectionVariable<U>, IQuery<TNew>>> iterator);
    ...
    ///     The current query.
    /// </returns>
    IQueryBuilder<TType, QueryContextSelfVars<TType, TVariables>> With<TVariables>(
    ...
    internal ISelectQuery<TResult, TNewContext> SelectInternal<TResult, TNewContext>(
        Action<ShapeBuilder<TResult>>? shape = null)
        where TNewContext : IQueryContextSelf<TResult>;
    ...
    IUpdateQuery<TSelected, TContext> Update<TSelected>(Expression<Func<TType, TContext, TSelected>> selector,
...
public interface IQueryBuilder
{
    ...
    /// </remarks>
    /// <param name="debug">
    ///     Whether or not to compile the query in a debug fashion, returning a
    ///     <see cref="DebugCompiledQuery" />.
    /// </param>
    /// <returns>
    ...
    ValueTask<CompiledQuery> CompileAsync(IEdgeDBQueryable edgedb, bool debug = false,
