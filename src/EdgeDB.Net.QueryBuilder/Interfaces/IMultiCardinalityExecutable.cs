...
public interface IMultiCardinalityExecutable<TType> : IQueryBuilder, IMultiCardinalityQuery<TType>
{
    ...
    /// </returns>
    Task<TType?> ExecuteSingleAsync(IEdgeDBQueryable edgedb, Capabilities? capabilities = Capabilities.Modifications,
    ...
    /// </returns>
    Task<TType> ExecuteRequiredSingleAsync(IEdgeDBQueryable edgedb,
        Capabilities? capabilities = Capabilities.Modifications, CancellationToken token = default);
}
