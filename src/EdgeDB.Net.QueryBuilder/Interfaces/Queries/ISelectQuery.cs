...
public interface ISelectQuery<TType, TContext> : IMultiCardinalityExecutable<TType> where TContext : IQueryContext
{
    ...
    ISelectQuery<TType, TContext> Filter(Expression<Func<TType, bool>> filter);
    ...
    /// <returns>The current query.</returns>
    ISelectQuery<TType, TContext> OrderBy<U>(Expression<Func<TType, U>> propertySelector,
        OrderByNullPlacement? nullPlacement = null);

    /// <inheritdoc
    ///     cref="ISelectQuery{TType, TContext}.OrderBy{U}(System.Linq.Expressions.Expression{System.Func{TType,U}},System.Nullable{EdgeDB.OrderByNullPlacement})" />
    ISelectQuery<TType, TContext> OrderBy<U>(Expression<Func<TType, TContext, U>> propertySelector,
        OrderByNullPlacement? nullPlacement = null);
    ...
    /// <param name="nullPlacement">The order of which null values should occur.</param>
    /// <returns>The current query.</returns>
    ISelectQuery<TType, TContext> OrderByDescending<U>(Expression<Func<TType, U>> propertySelector,
        OrderByNullPlacement? nullPlacement = null);

    /// <inheritdoc
    ///     cref="ISelectQuery{TType, TContext}.OrderByDescending{U}(System.Linq.Expressions.Expression{System.Func{TType,U}},System.Nullable{EdgeDB.OrderByNullPlacement})" />
    ISelectQuery<TType, TContext> OrderByDescending<U>(Expression<Func<TType, TContext, U>> propertySelector,
        OrderByNullPlacement? nullPlacement = null);
    ...
    /// <returns>The current query.</returns>
    ISelectQuery<TType, TContext> Offset(long offset);
    ...
    /// <returns>The current query.</returns>
    ISelectQuery<TType, TContext> Offset(Expression<Func<TContext, long>> offset);
    ...
    /// <returns>The current query.</returns>
    ISelectQuery<TType, TContext> Limit(long limit);
    ...
    /// <returns>The current query.</returns>
    ISelectQuery<TType, TContext> Limit(Expression<Func<TContext, long>> limit);
}
