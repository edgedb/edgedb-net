...
public readonly struct TransientTuple : ITuple
{
    ...
    internal static readonly Type[] ValueTupleTypeMap =
    {
        typeof(ValueTuple<>), typeof(ValueTuple<,>), typeof(ValueTuple<,,>), typeof(ValueTuple<,,,>),
        typeof(ValueTuple<,,,,>), typeof(ValueTuple<,,,,,>), typeof(ValueTuple<,,,,,,>), typeof(ValueTuple<,,,,,,,>)
    };

    internal static readonly Type[] ReferenceTupleTypeMap =
    {
    ...
    public static TransientTuple FromObjectEnumerator(ref ObjectEnumerator enumerator)
    {
        ...
        for (var i = 0; enumerator.Next(out _, out var value); i++)
        {
