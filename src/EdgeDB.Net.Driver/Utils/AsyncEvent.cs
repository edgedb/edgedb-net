    ...
    where T : class
{
    ...
    public AsyncEvent()
    {
        _subscriptions = new ConcurrentDictionary<int, T>();
    }
...
internal static class EventExtensions
{
    ...
    public static async ValueTask<T2[]> InvokeAsync<T1, T2>(this AsyncEvent<Func<T1, ValueTask<T2>>> eventHandler,
        T1 arg)
    {
        var subscribers = eventHandler.Subscriptions;

        var arr = new T2[subscribers.Length];
    ...
    public static async ValueTask InvokeAsync<T1, T2>(this AsyncEvent<Func<T1, T2, ValueTask>> eventHandler, T1 arg1,
        T2 arg2)
    {
        var subscribers = eventHandler.Subscriptions;
        for (var i = 0; i < subscribers.Length; i++)
    ...
    public static async ValueTask InvokeAsync<T1, T2, T3>(this AsyncEvent<Func<T1, T2, T3, ValueTask>> eventHandler,
    ...
    public static async ValueTask InvokeAsync<T1, T2, T3, T4>(
        this AsyncEvent<Func<T1, T2, T3, T4, ValueTask>> eventHandler, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
    {
        var subscribers = eventHandler.Subscriptions;
        for (var i = 0; i < subscribers.Length; i++)
    ...
    public static async ValueTask InvokeAsync<T1, T2, T3, T4, T5>(
        this AsyncEvent<Func<T1, T2, T3, T4, T5, ValueTask>> eventHandler, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
    {
        var subscribers = eventHandler.Subscriptions;
        for (var i = 0; i < subscribers.Length; i++)
