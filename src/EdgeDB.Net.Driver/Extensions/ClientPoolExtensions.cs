...
public static class ClientPoolExtensions
{
    ...
    public static async Task<TResult?> TransactionAsync<TResult>(this EdgeDBClient pool,
    ...
    /// <param name="func">The callback to pass the transaction into.</param>
    /// <returns>A Task that proxies the passed in callbacks awaiter.</returns>
    public static async Task TransactionAsync(this EdgeDBClient pool, TransactionSettings settings,
    ...
    /// <param name="func">The callback to pass the transaction into.</param>
    /// <returns>A Task that proxies the passed in callbacks awaiter.</returns>
    public static async Task<TResult?> TransactionAsync<TResult>(this EdgeDBClient pool, TransactionSettings settings,
        Func<Transaction, Task<TResult>> func)
    {
        await using var client = await pool.GetTransactibleClientAsync().ConfigureAwait(false);
