...
internal class ClassBuilder
{
    ...
    {
        var context = new ClassBuilderContext {Module = module, NameCallback = nameCallback};
    ...
    private string? ResolveTypename(ClassBuilderContext context, string? name)
    {
        ...
        if (context.Module.Types.Any(x => x.Name == name)) // try building it if it has a name ref
        {
