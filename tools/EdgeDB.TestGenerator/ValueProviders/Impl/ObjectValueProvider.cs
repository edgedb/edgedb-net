...
{
    internal class ObjectValueProvider : IWrappingValueProvider
    {
    ...
    internal sealed class IdenticallyNamedObjectValueProvider : ObjectValueProvider, IIdenticallyNamedProvider
    {
