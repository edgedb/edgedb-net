...
namespace EdgeDB.Translators
{
    internal partial class StdStrMethodTranslator : MethodTranslator<EdgeQL>
    {
        ...
        [MethodName(nameof(EdgeQL.Enc))]
        public void EncTranslator(QueryStringWriter writer, TranslatedParameter dataParam, TranslatedParameter alphabetParam, TranslatedParameter paddingParam)
        {
